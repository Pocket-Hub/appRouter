...
class Between extends _comparisonoperator.default {
  static fromDcn(dcnArguments = {}, schema) {
    return new Between(_value.default.fromDcn(dcnArguments[0], schema), _value.default.fromDcn(dcnArguments[1], schema), _value.default.fromDcn(dcnArguments[2], schema));
  }
  evaluate(input = {}) {
