...
class LessThan extends _comparisonoperator.default {
  static fromDcn(dcnArguments = {}, schema) {
    return new LessThan(_value.default.fromDcn(dcnArguments[0], schema), _value.default.fromDcn(dcnArguments[1], schema));
  }
  evaluate(input = {}) {
