...
class LessEqual extends _comparisonoperator.default {
  static fromDcn(dcnArguments = {}, schema) {
    return new LessEqual(_value.default.fromDcn(dcnArguments[0], schema), _value.default.fromDcn(dcnArguments[1], schema));
  }
  evaluate(input = {}) {
    const v1 = this.values[0].resolve(input);
    const v2 = this.values[1].resolve(input);
    if (v1.constant === undefined || v2.constant === undefined) {
      return new LessEqual(v1, v2);
    } else {
